        ...
        >
          <div className="space-y-12 text-center lg:text-left">
            <motion.div 
              ...
              className="inline-flex items-center gap-4 px-8 py-3 rounded-full bg-primary/10 border-2 border-primary/20 text-[10px] sm:text-[11px] font-black text-primary uppercase tracking-[0.6em] mx-auto lg:mx-0 shadow-2xl backdrop-blur-xl"
            >
            ...
            <p className="text-sm sm:text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-2xl font-bold uppercase tracking-[0.25em] opacity-80 mx-auto lg:mx-0">
          ...
          <div className="grid grid-cols-1 gap-10">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-[11px] font-black uppercase text-primary tracking-[0.6em] mb-3 opacity-60">PRIMARY ENDPOINT</p>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-[11px] font-black uppercase text-primary tracking-[0.6em] mb-3 opacity-60">MOBILE SUBSYSTEM</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-12 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-5">
                <label className="text-[10px] sm:text-[11px] font-black uppercase text-muted-foreground tracking-[0.6em] ml-8">FULL NAME</label>
              ...
              <div className="space-y-5">
                <label className="text-[10px] sm:text-[11px] font-black uppercase text-muted-foreground tracking-[0.6em] ml-8">EMAIL ADDRESS</label>
                <div className="relative group">
                  <Input 
                    type="email" 

...
const synthesisNodes = [
  { 
    ...
    desc: "React & Next.js",
    status: "Active",
    metrics: ["120fps Render Engine", "Fluid Logic Mapping"]
  },
  { 
    id: "fullstack",
    ...
    status: "Synced",
    metrics: ["ACID Compliance Locked", "Real-time Data Sink"]
  },
  { 
    id: "uiux",
    label: "Industrial UI", 
    icon: Palette, 
    color: "text-cyan-500", 
    desc: "Recruiter-Optimized",
    status: "Mapped",
    metrics: ["High-Contrast UX", "Responsive Vectors"]
  },
  { 
    id: "ai",
    ...
    icon: Cpu, 
    color: "text-primary", 
    desc: "Genkit Orchestration",
    status: "Neural",
    metrics: ["Semantic Intent Parsing", "LLM Native Logic"]
  }
];
...
export function About() {
  ...
  return (
    <section id="about" className="py-24 sm:py-40 px-4 sm:px-6 relative overflow-hidden bg-background border-t-2 border-border scroll-mt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
          ...
          >
            <div className="space-y-8 text-center lg:text-left">
              <div className="inline-flex items-center gap-4 px-6 py-2.5 rounded-full bg-primary/10 text-[12px] font-black tracking-[0.5em] text-primary uppercase border-2 border-primary/20 mx-auto lg:mx-0 shadow-lg">
              ...
              <p className="text-sm sm:text-xl text-muted-foreground leading-relaxed font-bold max-w-xl mx-auto lg:mx-0 opacity-80 uppercase tracking-widest">
                Architecting digital ecosystems where <span className="text-primary font-black">high-performance logic</span> meets industrial stability.
              </p>
            </div>
          ...
          <div className="relative pt-12 lg:pt-0">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="w-full"
              >
                <div className="p-10 sm:p-16 rounded-[3rem] border-2 border-border/80 bg-card space-y-12 relative overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.4)]">
                  <div className="flex flex-col items-center gap-8 relative z-10">
                    <div className="relative p-8 rounded-full bg-background border-2 border-border shadow-3xl">
                    ...
                    <div className="text-center space-y-3">
                      <p className="text-[12px] font-black uppercase tracking-[0.6em] text-primary opacity-60">Technical Registry Node</p>
                  ...
                  <div className="grid grid-cols-1 gap-4 relative z-10">
                    {activeNode.metrics.map((metric, i) => (
                      <div key={i} className="flex items-center justify-between p-6 rounded-2xl bg-background border-2 border-border shadow-xl group hover:border-primary transition-all">
                        <span className="text-[10px] font-black uppercase tracking-[0.6em] text-muted-foreground opacity-40">Metric Vector</span>
                  ...
                  <div className="pt-10 border-t-2 border-border/50 flex items-center justify-between relative z-10">
                    <div className="flex items-center gap-5">
                      ...
                      <div className="flex flex-col">
                        <span className="text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground/50 leading-none mb-1.5">System Status</span>
                        <span className="text-[12px] font-black text-green-500 uppercase tracking-widest">{activeNode.status} Registry</span>
                      </div>
                    </div>

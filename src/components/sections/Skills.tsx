...
export function Skills() {
  return (
    <section id="skills" className="py-24 sm:py-32 px-4 sm:px-6 relative overflow-hidden bg-transparent border-t-2 border-border scroll-mt-20">
      <div className="max-w-7xl mx-auto space-y-24 relative z-10">
        <div className="text-center space-y-8">
          ...
          <p className="text-sm sm:text-lg text-muted-foreground max-w-3xl mx-auto font-bold uppercase tracking-[0.2em] opacity-70">
              ...
              <Tooltip key={skill.name}>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span className="font-black tracking-widest text-[11px] uppercase whitespace-nowrap">{skill.name}</span>
                  </motion.div>
                </TooltipTrigger>
                <TooltipContent className="glass-card p-6 border-2 border-border rounded-2xl space-y-4 shadow-4xl backdrop-blur-3xl bg-background/95">
                  <p className="text-[11px] font-black uppercase text-primary tracking-[0.4em] opacity-60 leading-none">{skill.category}</p>

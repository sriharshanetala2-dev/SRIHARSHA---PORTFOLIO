            ...
            <Card className="bg-background/40 border-border/50 overflow-hidden backdrop-blur-xl">
              <CardHeader className="flex flex-row items-center justify-between p-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => handleSimulatedAction("Query Registry")} className="p-1.5 rounded-lg border border-border hover:bg-secondary transition-all"><Search className="w-3 h-3" /></button>
                </div>
              </CardHeader>
                  ...
                  <Table className="min-w-[500px] sm:min-w-full">
                    <TableHeader>
                      <TableRow className="border-border/50 hover:bg-transparent">
                        <TableHead className="text-[8px] sm:text-[10px] font-black uppercase tracking-widest px-4">ID</TableHead>
                        <TableHead className="text-[8px] sm:text-[10px] font-black uppercase tracking-widest px-4">Name</TableHead>
                        <TableHead className="hidden sm:table-cell text-[8px] sm:text-[10px] font-black uppercase tracking-widest px-4">Course</TableHead>
                        <TableHead className="text-[8px] sm:text-[10px] font-black uppercase tracking-widest px-4">GPA</TableHead>
                        <TableHead className="text-right px-4 text-[8px] sm:text-[10px] font-black uppercase tracking-widest">Status</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {studentActivity.map((student) => (
                        <TableRow key={student.id} className="border-border/20 group hover:bg-primary/5 transition-colors">
                          ...
                          <TableCell className="font-black text-primary text-[10px] sm:text-xs">{student.gpa}</TableCell>
          ...
          <div className="space-y-4 sm:space-y-8 animate-in fade-in duration-700">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                >
                  <CardContent className="p-4 sm:p-8 flex items-center justify-between">

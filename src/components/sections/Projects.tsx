...
const projects = [
  {
    ...
    category: "Web",
    image: PlaceHolderImages[0] || { imageUrl: "https://placehold.co/800x600", imageHint: "placeholder" },
  ...
  },
  {
    ...
    category: "Mobile",
    image: PlaceHolderImages[1] || { imageUrl: "https://placehold.co/800x600", imageHint: "placeholder" },
  ...
  },
  {
    ...
    image: PlaceHolderImages[2] || { imageUrl: "https://placehold.co/800x600", imageHint: "placeholder" },
  ...
  },
  {
    title: "FinFlow",
    category: "Web",
    image: PlaceHolderImages[3] || { imageUrl: "https://placehold.co/800x600", imageHint: "placeholder" },
  ...
  },
  {
    title: "Linguist AI",
    category: "AI",
    image: PlaceHolderImages[4] || { imageUrl: "https://placehold.co/800x600", imageHint: "placeholder" },
  ...
  },
  {
    ...
    category: "Mobile",
    image: PlaceHolderImages[5] || { imageUrl: "https://placehold.co/800x600", imageHint: "placeholder" },

...
export function Projects() {
  ...
  return (
    <section id="portfolio" className="py-24 sm:py-48 px-4 sm:px-6 relative overflow-hidden bg-background/20 border-t-2 border-border scroll-mt-20">
      {/* Localized Background Logic Subsystem */}
      <div className="absolute inset-0 neural-grid opacity-[0.2] dark:opacity-[0.15] pointer-events-none" />
      <div className="absolute inset-0 data-packet-layer opacity-30 pointer-events-none" />
      <div className="logic-scan-subsystem opacity-40" />
      ...
      <div className="max-w-7xl mx-auto space-y-24 sm:space-y-32 relative z-10">
        <div className="space-y-10 text-center">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-4 px-8 py-3 rounded-2xl bg-primary/15 border-2 border-primary/25 text-[11px] font-black tracking-[0.6em] text-primary uppercase mx-auto shadow-2xl backdrop-blur-xl"
          >
          ...
          <motion.h2 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-4xl sm:text-7xl lg:text-9xl font-headline font-black tracking-tighter uppercase leading-none shimmer-text"
          >

...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-24 sm:py-40 px-6 relative overflow-hidden bg-background border-t border-border/50 scroll-mt-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 sm:gap-24 relative z-10">
        ...
        >
          <div className="space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-primary/10 border border-primary/20 text-[11px] font-black text-primary uppercase tracking-[0.5em] mx-auto lg:mx-0 shadow-lg">
            ...
            <p className="text-xs sm:text-lg text-muted-foreground leading-relaxed max-w-lg font-bold uppercase tracking-widest opacity-70 mx-auto lg:mx-0">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="bg-card/40 backdrop-blur-xl border border-border/50 p-8 sm:p-14 rounded-[3rem] shadow-3xl relative"
        >
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase text-muted-foreground tracking-[0.4em] ml-2">FULL NAME</label>
                <div className="relative">
                  <Input 
                    placeholder="ENTER NAME" 
                    required
                    className="bg-background/50 border border-border focus:ring-primary h-16 rounded-2xl text-[11px] font-black pl-14 shadow-inner uppercase tracking-widest"
                    value={formData.name}
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase text-muted-foreground tracking-[0.4em] ml-2">EMAIL ADDRESS</label>
                <div className="relative">
                  <Input 
                    type="email" 
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black uppercase text-muted-foreground tracking-[0.4em] ml-2">MESSAGE</label>
              <Textarea 
                placeholder="TYPE YOUR MESSAGE..." 
                className="min-h-[180px] bg-background/50 border border-border focus:ring-primary p-8 resize-none rounded-[2.5rem] text-[11px] font-black leading-relaxed shadow-inner uppercase tracking-tight"
                required
            ...
            <Button 
              type="submit" 
              className="w-full h-20 rounded-full font-black uppercase tracking-[0.5em] text-[11px] gap-4 shadow-3xl transition-all bg-primary text-primary-foreground hover:scale-[1.02] active:scale-95 shadow-primary/30"
              disabled={isSubmitting}
            >

    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <main className="pt-32 sm:pt-44 pb-20 sm:pb-32 px-4 sm:px-12 relative z-10">
        <div className="max-w-7xl mx-auto space-y-16 sm:space-y-32">
          ...
          <Link 
            href="/#portfolio" 
            className="inline-flex items-center gap-4 text-[11px] font-black text-primary uppercase tracking-[0.6em] hover:gap-8 transition-all group"
          >
          ...
          {/* Visual Hero HUD - Aspect Ratio adjusted for mobile clarity */}
          <motion.div 
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-20">
              ...
              <div className="relative z-10 flex flex-col items-center gap-8 sm:gap-20 w-full">
                ...
                <div className="flex flex-col items-center gap-2 sm:gap-4">
                  <p className="text-[10px] font-black uppercase tracking-[0.8em] text-primary opacity-60">System Core Node</p>
                  <h3 className="text-xl sm:text-6xl font-black uppercase tracking-tighter text-center px-4 leading-tight">{project.title}</h3>
                </div>

                {/* Metrics Control Panel - Horizontal Persistence for 3 Metrics */}
                <div className="grid grid-cols-3 items-center justify-center gap-2 sm:gap-12 px-4 sm:px-20 py-6 sm:py-12 glass-card rounded-[2rem] sm:rounded-[4rem] border-white/10 bg-background/60 shadow-3xl backdrop-blur-2xl w-full max-w-4xl mx-auto">
                   {project.metrics.map((metric, i) => (
                     <div key={i} className="flex flex-col items-center px-1 sm:px-12 border-r last:border-0 border-border/30 overflow-hidden">
            ...
            {/* Corner Decorative Elements - Scaled for visibility */}
            <div className="absolute top-4 left-4 sm:top-14 sm:left-14 flex gap-2 sm:gap-4">
               <div className="w-8 h-8 sm:w-16 sm:h-16 rounded-lg sm:rounded-3xl glass-card border-white/5 bg-black/40 flex items-center justify-center shadow-2xl">
            ...
            <div className="absolute bottom-4 left-4 sm:bottom-14 sm:left-14 p-2 sm:p-8 glass-card rounded-xl sm:rounded-[2.5rem] border-white/10 bg-black/60 flex items-center gap-2 sm:gap-4 shadow-3xl">
            ...
            <div className="lg:col-span-4 space-y-12">
              <div className="p-10 sm:p-20 rounded-[3rem] sm:rounded-[5.5rem] bg-card/60 border border-border/60 space-y-12 sm:space-y-24 lg:sticky lg:top-44 shadow-3xl backdrop-blur-3xl overflow-hidden">
                ...
                <div className="space-y-10 sm:space-y-12 relative z-10">
                  <p className="text-[11px] font-black text-primary uppercase tracking-[0.6em] flex items-center gap-5">
                ...
                <div className="pt-12 sm:pt-20 border-t border-border/40 space-y-10 relative z-10">
                  <p className="text-[11px] font-black text-accent uppercase tracking-[0.6em] flex items-center gap-5">
                  ...
                  <div className="space-y-6 sm:space-y-10">
                    {project.metrics.map((m, i) => (
                      <div key={i} className="flex items-center justify-between">
                        ...
                        <span className="text-xs sm:text-2xl font-black text-primary uppercase font-headline">{m.value}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="pt-12 sm:pt-24 border-t border-border/40 text-center opacity-40">
                   <p className="text-[10px] text-muted-foreground font-black uppercase tracking-[0.8em]">
